...
export default function RecipeCard({
  ...
  const handleFavoriteClick = () => {
    console.log("❤️ CLICKED:", title, id, isFavorite);

    if (!isLoggedIn) {
      console.log("FAVORITE BLOCKED: user is not logged in");
      onAuthRequired?.();
      return;
    }

    console.log("FAVORITE TOGGLE:", id, isFavorite);
