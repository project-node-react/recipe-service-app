      ...
      <form className={styles.formGrid} onSubmit={formik.handleSubmit}>
        ...
        <div className={styles.photoSection}>
              ...
              <div className={styles.photoPlaceholder}>
                <span className={styles.photoIcon} aria-hidden="true">
                  <svg className={styles.captureFrame}>
                    <use
                      href={`${import.meta.env.BASE_URL}icons.svg#capture-frame`}
                    />
                  </svg>
          ...
          {formik.touched.photo && formik.errors.photo && (
            <div className={styles.errorText}>{formik.errors.photo}</div>
          )}
        </div>
        ...
        <div className={styles.detailsSection}>
          ...
          <div className={styles.inputGroup}>
            ...
            />
            <span
              className={`${styles.charCount} ${styles.descriptionCharCount}`}
            >
              <span
                className={
          ...
          <div>
            ...
            {formik.touched.area && formik.errors.area && (
              <div className={styles.errorText}>{formik.errors.area}</div>
            )}
          </div>
                  ...
                  <div key={index} className={styles.ingredientCard}>
                    ...
                    >
                      <svg className={styles.removeIcon} aria-hidden="true">
                        <use
                          href={`${import.meta.env.BASE_URL}icons.svg#close-small`}
                        />
                      </svg>
                    </button>
                  </div>
          ...
          <div className={styles.inputGroup}>
            ...
            />
            <span
              className={`${styles.charCount} ${styles.instructionsCharCount}`}
            >
              <span
                className={
